...
picture {
	...
	background:
		radial-gradient(hsl(0 0% 0% / 25%) 0.5px, transparent 0.5px) 0 0 /3px 3px,
		radial-gradient(hsl(0 0% 0% / 25%) 0.5px, transparent 0.5px) 1px 1px /3px 3px,
		radial-gradient(hsl(0 0% 0% / 25%) 0.5px, transparent 0.5px) 2px 2px /3px 3px
}
</style>
